...
- **Main Functions/Features**: Makes an API call to `/session/all`, handles loading/error states, and renders cards showing device types, OS, browser, and start time for each active session.
