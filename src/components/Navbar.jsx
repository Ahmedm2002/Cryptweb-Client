...
export default function Navbar() {
  return (
    <nav
      ...
      className="fixed top-0 w-full z-50 bg-white/40 backdrop-blur-md shadow-glass transition-all"
    >
      <div className="flex justify-between items-center w-full px-6 md:px-12 py-4 max-w-7xl mx-auto">
        ...
        <a
          ...
          className="text-xl font-black tracking-tighter text-surface-on-surface flex items-center gap-2"
        >
          <span
