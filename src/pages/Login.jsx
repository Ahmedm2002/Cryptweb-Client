    ...
    <div className="min-h-[calc(100vh-5rem)] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-gray-50 flex-col">
      <div className="max-w-md w-full space-y-8 bg-white p-10 rounded-3xl shadow-sm border border-gray-100">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          {error && <div className="text-red-700 text-sm bg-red-50 border border-red-100 p-4 rounded-xl">{error}</div>}
          ...
          <div className="flex flex-col space-y-4 pt-2">
            <Button type="submit" variant="primary" className="w-full flex justify-center py-3 text-[15px]" disabled={loading}>
        ...
        <div className="text-sm text-center mt-8">
          ...
          <Link to="/signup" className="font-semibold text-indigo-600 hover:text-indigo-500 transition-colors">Sign up</Link>
        </div>
      </div>
    </div>
  );
