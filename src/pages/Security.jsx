          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 font-medium mb-6 leading-relaxed">
                To provide you with a fast, reliable service, Cryptweb utilizes
                lightweight signaling servers to help devices "find" each other.
                Think of us as the operator connecting the call.
              </p>
            ...
            <div className="bg-white p-8 sm:p-12 rounded-3xl shadow-md border border-gray-100 relative">
              <div className="flex flex-col sm:flex-row items-center justify-between gap-6 relative z-10">
                ...
                <div className="flex-1 flex flex-col items-center px-4 w-full sm:w-auto relative">
                  ...
                  <span className="text-xs font-bold text-indigo-600 mt-3 whitespace-nowrap bg-white px-2">
                    AES-GCM Tunnel
                  </span>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-lg text-gray-400 font-medium">
              Every connection establishes a unique cryptographic handshake. If
              data is modified in transit, the transfer instantly terminates.
            </p>
          </div>
